                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <Label className="text-gray-400 block mb-2">State</Label>
                                                <Input
                                                    name="stateCode"
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                <Label className="text-gray-400 block mb-2">ZIP Code</Label>
                                                <Input
                                                    name="zipCode"
                                            ...
                                            <div>
                                                <Label className="text-gray-400 block mb-2">Country</Label>
                                                <Input
                                                    name="countryCode"
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <h3 className="text-lg font-semibold text-white">Parcel Details</h3>
                                        </div>
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                <Label className="text-gray-400 block mb-2">Weight (lbs)</Label>
                                                <Input
                                                    name="weight"
                                            ...
                                            <div>
                                                <Label className="text-gray-400 block mb-2">Length (inches)</Label>
                                                <Input
                                                    name="length"
                                            ...
                                            <div>
                                                <Label className="text-gray-400 block mb-2">Width (inches)</Label>
                                                <Input
                                                    name="width"
                                            ...
                                            <div>
                                                <Label className="text-gray-400 block mb-2">Height (inches)</Label>
                                                <Input
                                                    name="height"
                                        ...
                                        <div>
                                            <Label className="text-gray-400 block mb-2">Weekly Charges ($)</Label>
                                            <Input
                                                name="weeklyCharges"
                                                value={weeklyCharges}
