                  ...
                  <div className="space-y-6">
                    <div>
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-lg font-semibold text-white">Destination Address</h3>
                      </div>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-4">Parcel Details</h3>
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <Label className="text-gray-400">Weight (lbs)</Label>
                          <Input
                            name="weight"
                        ...
                        <div>
                          <Label className="text-gray-400">Length (inches)</Label>
                          <Input
                            name="length"
                        ...
                        <div>
                          <Label className="text-gray-400">Width (inches)</Label>
                          <Input
                            name="width"
                        ...
                        <div>
                          <Label className="text-gray-400">Height (inches)</Label>
                          <Input
                            name="height"
                    ...
                    <div>
                      <Label className="text-gray-400">Weekly Charges ($)</Label>
                      <Input
                        name="weeklyCharges"
                        value={weeklyCharges}
                  ...
                  <Card className="bg-[#2A2A36] border-gray-700">
                    <div className="p-6">
                      <div className="grid grid-cols-4 gap-4 mb-4 text-sm font-medium text-gray-400 px-4">
                        ...
                        <div>Discount</div>
                        <div>Over Discounted</div>
                        <div>Savings</div>
                      </div>

                      <div className="space-y-2">
                        {discountData.map((service, index) => (
                          <div key={index} className="grid grid-cols-4 gap-4 items-center bg-[#23232F] rounded-xl p-4">
                            <div className="font-medium text-white">{service.service_name}</div>
                            <div className="text-gray-400">{service.service_discount.toFixed(2)}%</div>
                            <div className="text-gray-400">{service.is_over_discounted ? "Yes" : "No"}</div>
                            <div className="flex items-center gap-3">
                              <div className="flex-1 h-2 bg-gray-700 rounded-full overflow-hidden">
                                <div
                                  className={`h-full ${getDiscountColor(service.service_discount)} transition-all`}
                                  style={{ width: `${service.service_discount}%` }}
                                />
                              </div>
